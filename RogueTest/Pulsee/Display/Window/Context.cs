...
using RogueTest.Pulsee.Devices.Display.Window;

namespace Pulsee.Devices.Display.Window
{
    class Context : Ple_GameWindow
    {
                  ...
                  GraphicsContextFlags.ForwardCompatible)
        {
            ...
            ChangeIco(new System.Drawing.Icon(@"Pulsee\KernelContent\Pictures\Icos\build.ico"));
        }
